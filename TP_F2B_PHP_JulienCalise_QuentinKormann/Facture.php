...
<?php
$reponse= $bdd->query("SELECT client.NumClient, NomClient, PrenomClient, AdresseClient, Cp, VilleClient, PaysClient, NumFacture, DateFacture  FROM facture,client WHERE facture.NumClient = client.NumClient ORDER BY client.NumClient");
...
while($donnees = $reponse->fetch())
{
	?>
		...
		<tr>
			<td><?php echo $donnees['NumFacture']; ?></td>
